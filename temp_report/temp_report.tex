...
visto que o objetivo aqui é prever o consumo médio de combustível de carros.
...
Para os atributos categóricos será utilizada a codificação One Hot Encodeding.

Um dos problemas encontrados até o momento foi a possibilidade de não ser visto algum modelo de carro (model) no treinamento. 
Isso pode acontecer pois há uma quantidade muito grande de modelos diferentes, alguns com poucas instâncias.
Para solucionar esse problema nós "forçamos" a ter pelo menos uma instância de cada modelo no conjunto de treinamento.
